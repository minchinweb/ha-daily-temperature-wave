...
class TestCoreFunctionality:
    ...
    def test_sine_wave_calculation(self):
        ...
        hours_from_noon = 0
        temp = calculate_sine_wave_temp(min_temp, max_temp, hours_from_noon, wave_spread)
    ...
    def test_wave_spread_effect(self):
        ...
        temp_standard = calculate_sine_wave_temp(min_temp, max_temp, hours_from_noon, 1.0)
